...
import com.zj.mobilesafe.EnterPwdActivity;
...
public class WatchDogService extends Service {
	...
	public void onCreate() {
		...
		registerReceiver(innerReceiver, new IntentFilter(
				"com.itheima.mobilesafe.tempstop"));
		dataChangeReceiver = new DataChangeReceiver();
		registerReceiver(dataChangeReceiver, new IntentFilter("com.zj.mobilesafe.applockchange"));
