...
import com.zj.mobilesafe.db.dao.ApplockDao;
import com.zj.mobilesafe.domain.AppInfo;
import com.zj.mobilesafe.enginee.AppInfoProvider;
import com.zj.mobilesafe.utils.DensityUtil;
...
public class AppManagerActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv_avail_sd.setText("SD卡可用空间为"+Formatter.formatFileSize(this, sdsize));
		tv_avail_rom.setText("内存可用空间为"+Formatter.formatFileSize(this, romsize));
		...
		// 给listview注册一个滚动的监听器
				 ...
				 * 设置listview的点击事件
				 */
				lv_app_manager.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
					@Override
...
//			if(position<userAppInfos.size())  //用户程序显示
//			{
